...
class SensorService:
    ...
    async def create_sensor_readings_batch(db: AsyncSession, batch_data: SensorDataBatchCreate) -> List[SensorDataResponse]:
        ...
        return [SensorDataResponse.model_validate(reading) for reading in sensor_readings]
    ...
    async def get_sensor_readings(
        ...
        return [SensorDataResponse.model_validate(reading) for reading in readings]
    ...
    async def create_sensor_type(db: AsyncSession, sensor_type_data: SensorTypeCreate) -> SensorTypeResponse:
        ...
        return SensorTypeResponse.model_validate(db_sensor_type)
    ...
    async def get_sensor_types(db: AsyncSession) -> List[SensorTypeResponse]:
        ...
        return [SensorTypeResponse.model_validate(sensor_type) for sensor_type in sensor_types]